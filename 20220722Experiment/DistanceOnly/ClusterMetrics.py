...
def buildDataFrame(table):
    ...
    for row5 in ei_ids:
        data["id"] = row5[0]
        ei_child_query = ("SELECT ei_id_1, child_id_1, driving_distance "
                          f"from {table} "
        ...
        ei1_ei_query = ("SELECT ei_id_1, ei_id_2, driving_distance "
                        f"from {table} "
        ...
        ei_ei2_query = ("SELECT ei_id_1, ei_id_2, driving_distance "
                        f"from {table} "
