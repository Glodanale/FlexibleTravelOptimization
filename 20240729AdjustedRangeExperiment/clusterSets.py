...
def eiLocationClusters():
    ...
    for row in ei_ids:
        ...
        for row2 in ei_child:
            ...
            data[f'{row2[0]}_distance'] = distance
            data[f'{row2[0]}_time'] = time
        ...
        for row3 in ei1_ei:
            ...
            data[f'{row3[1]}_distance'] = distance
            data[f'{row3[1]}_time'] = time
        ...
        for row4 in ei_ei2:
            ...
            data[f'{row4[0]}_distance'] = distance
            data[f'{row4[0]}_time'] = time
    ...
    for ei in ei_ids:
        ...
        for child in assignedChild:
            ...
            for row2 in child1_child:
                ...
                data[f'{row2[1]}_distance'] = distance
                data[f'{row2[1]}_time'] = time
            ...
            for row3 in child_child2:
                ...
                data[f'{row3[0]}_distance'] = distance
                data[f'{row3[0]}_time'] = time
            ...
            for row4 in child_ei:
                ...
                data[f'{row4[1]}_distance'] = distance
                data[f'{row4[1]}_time'] = time
